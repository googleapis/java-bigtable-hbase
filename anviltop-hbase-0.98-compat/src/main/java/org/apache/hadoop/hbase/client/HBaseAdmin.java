...
public class HBaseAdmin implements Abortable, Closeable, Admin {
 ...
 public synchronized  byte[][] rollHLogWriter(String serverName)
  ...
  @Override
  public void flushRegion(byte[] regionName) throws IOException, InterruptedException {
  ...
  @Override
  public void compactRegion(byte[] regionName) throws IOException, InterruptedException {
  ...
  @Override
  public void majorCompactRegion(byte[] regionName) throws IOException, InterruptedException {
  ...
  @Override
  public void splitRegion(byte[] regionName) throws IOException, InterruptedException {
