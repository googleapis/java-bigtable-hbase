...
public class HTable implements HTableInterface {
  ...
  /**
  /* (non-Javadoc)
   * @see org.apache.hadoop.hbase.client.Table#checkAndDelete(byte[], byte[], byte[], org.apache.hadoop.hbase.filter.CompareFilter.CompareOp, byte[], org.apache.hadoop.hbase.client.Delete)
   */
  @Override
