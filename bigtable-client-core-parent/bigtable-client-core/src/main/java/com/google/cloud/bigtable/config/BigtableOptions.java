...
public abstract class BigtableOptions implements Serializable, Cloneable {
  ...
  // If set to a host:port address, this environment variable will configure the
  // client to connect
  // to a Bigtable emulator running at the given address with plaintext
  // negotiation.
  // TODO: Link to emulator documentation when available.
  /**
   * Constant
   * <code>BIGTABLE_EMULATOR_HOST_ENV_VAR="bigtableadmin.googleapis.com"</code>
   */
  public static final String BIGTABLE_EMULATOR_HOST_ENV_VAR = "BIGTABLE_EMULATOR_HOST";

  /**
   * Constant
   * <code>BIGTABLE_ADMIN_HOST_DEFAULT="bigtableadmin.googleapis.com"</code>
   */
  ...
  /**
   * Constant
   * <code>BIGTABLE_BATCH_DATA_HOST_DEFAULT="bigtable.googleapis.com"</code>
   */
  ...
  /**
   * Constant
   * <code>BIGTABLE_DATA_CHANNEL_COUNT_DEFAULT=getDefaultDataChannelCount()</code>
   */
  public static final int BIGTABLE_DATA_CHANNEL_COUNT_DEFAULT = getDefaultDataChannelCount();

  /**
   * Constant <code>BIGTABLE_APP_PROFILE_DEFAULT=""</code>, defaults to the
   * server default app profile
   */
