...
public interface BigtableInstanceClient {
   ...
   * @throws TimeoutException If the operation takes longer than 10 minutes.
   */
  void waitForOperation(Operation operation) throws TimeoutException, InterruptedException;
