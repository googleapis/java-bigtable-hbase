...
public class ITDurability extends AbstractTest {
  /**
   * Requirement 1.5 - A client can specify the durability guarantee of any mutation.
   *
   * <p>Bigtable can do without durability hints. Its recovery and write-throughput is fast enough
  ...
  private void testDurability(Durability durability) throws IOException {
    ...
    Assert.assertArrayEquals(
        "Durability=" + durability, testValue, CellUtil.cloneValue(cells.get(0)));
