...
public class TestCustomCredentialsProvider {
  ...
  static class TestCredentials extends BigtableOAuthCredentials {
    ...
    @Override
    public CompletableFuture<Map<String, List<String>>> getRequestMetadata(URI uri,
        Executor executor) throws IOException {
      return CompletableFuture.completedFuture(mockRequestMetadata.get(uri));
    }

    private static Map<URI, Map<String, List<String>>> mockRequestMetadata = new HashMap<>();
  }
  ...
  public void setup() {
    ...
    credentials = CustomCredentialsProvider.getCustomCredentials(
