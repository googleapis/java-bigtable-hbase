 ...
 *
 * Example:
 * If you have exported your HBase Snapshot to GCS bucket gs://$HBASE_EXPORT_ROOT_PATH and want to
 * import snapshot gs://$HBASE_EXPORT_ROOT_PATH/.hbase-snapshot/$SNAPSHOT_NAME into Cloud Bigtable
 * $TABLE in $INSTANCE, execute the following command to run the job directly:
 *
 * <pre>
 ...
 * </pre>
 *
 * Note: restoreDir is a GCS path used to save temporal files generated by Snapshot scans.
 * and it must not be a sub-folder of the hbaseSnapshotSourceDir.
 */
