...
public class CloudBigtableIO {
  ...
  public static class Source<ResultOutputType> extends AbstractSource<ResultOutputType> {
     ...
     */
    @Override
    public List<? extends BoundedSource<ResultOutputType>> split(long desiredBundleSizeBytes,
  ...
  public static class CloudBigtableSingleTableSerialWriteFn
    ...
    private static final long serialVersionUID = 2L;
    private static final Counter mutationsCounter = Metrics.counter(CloudBigtableIO.class, "Mutations");
    ...
    @StartBundle
    private synchronized void getTable() throws IOException {
   ...
   */
  public static BoundedSource<Result[]> readBulk(CloudBigtableScanConfiguration config,
      int resultCount) {
