...
public class ITColumnFamilyAdminHBase2 extends AbstractTestColumnFamilyAdmin {
  ...
  protected void addColumn(byte[] columnName, int version) throws Exception {
    ColumnFamilyDescriptor descriptor =
        ColumnFamilyDescriptorBuilder.newBuilder(columnName).setMaxVersions(version).build();
