...
public class BigtableBufferedMutator implements BufferedMutator {
   ...
   */
  private static class HeapSizeManager {
  ...
  private static class MutationException {
    ...
    private MutationException(Row mutation, Throwable throwable) {
  ...
  private final List<MutationException> globalExceptions =
      new ArrayList<MutationException>();
