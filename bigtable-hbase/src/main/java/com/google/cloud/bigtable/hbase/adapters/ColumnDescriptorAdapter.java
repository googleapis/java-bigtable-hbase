...
public class ColumnDescriptorAdapter {
   ...
   * </p>
   * <p>
   * This method will likely throw IllegalStateException if the GC Expression isn't similar to
   * buildGarbageCollectionExpression's expression. Requires the input to be empty/null or "[(age >
   * \d+ [&& version() > \d+]) ||] version() > \d" as generated by
   * {@link #buildGarbageCollectionExpression(HColumnDescriptor)}
   * </p>
   */
   ...
   * See {@link #convertGarbageCollectionExpression(String, HColumnDescriptor)} for more info.
   */
