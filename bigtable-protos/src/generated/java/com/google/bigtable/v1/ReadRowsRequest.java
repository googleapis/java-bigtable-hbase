...
public  final class ReadRowsRequest extends
  ...
  public static final int DEPRECATED_STRING_FILTER_FIELD_NUMBER = 4;
  private java.lang.Object dEPRECATEDStringFilter_;
  /**
   ...
   * </pre>
   */
  public java.lang.String getDEPRECATEDStringFilter() {
    java.lang.Object ref = dEPRECATEDStringFilter_;
    if (ref instanceof java.lang.String) {
      return (java.lang.String) ref;
    } else {
      com.google.protobuf.ByteString bs = 
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getDEPRECATEDStringFilterBytes().isEmpty()) {
      output.writeBytes(4, getDEPRECATEDStringFilterBytes());
    }
    if (filter_ != null) {
  ...
  public int getSerializedSize() {
    ...
    if (!getDEPRECATEDStringFilterBytes().isEmpty()) {
      size += com.google.protobuf.CodedOutputStream
        .computeBytesSize(4, getDEPRECATEDStringFilterBytes());
    }
    if (filter_ != null) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public static final class Builder extends
    ...
    public com.google.bigtable.v1.ReadRowsRequest buildPartial() {
      ...
      result.dEPRECATEDStringFilter_ = dEPRECATEDStringFilter_;
      if (filterBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.bigtable.v1.ReadRowsRequest other) {
      ...
      if (!other.getDEPRECATEDStringFilter().isEmpty()) {
        dEPRECATEDStringFilter_ = other.dEPRECATEDStringFilter_;
        onChanged();
      }
      if (other.hasFilter()) {
  ...
  targetCase_ = 2;
     ...
     * </pre>
     */
    public Builder setDEPRECATEDStringFilter(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
  
      dEPRECATEDStringFilter_ = value;
      onChanged();
      return this;
    }
    /**
     ...
     * </pre>
     */
    public Builder clearDEPRECATEDStringFilter() {
      
      dEPRECATEDStringFilter_ = getDefaultInstance().getDEPRECATEDStringFilter();
      onChanged();
      return this;
    }
    /**
     ...
     * </pre>
     */
    public Builder setDEPRECATEDStringFilterBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
  ...
  private static final com.google.bigtable.v1.ReadRowsRequest defaultInstance;static {
    defaultInstance = new com.google.bigtable.v1.ReadRowsRequest();
  }
