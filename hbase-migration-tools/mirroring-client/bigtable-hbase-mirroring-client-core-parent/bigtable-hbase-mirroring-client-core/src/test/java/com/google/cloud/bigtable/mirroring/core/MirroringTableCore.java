...
/**
 * mirroring-client-core can't implement some methods because they will conflict with HBase 2x. This
 * is a helper to test the partial implementation
 */
public class MirroringTableCore extends MirroringTable {

  public MirroringTableCore(
      Table primaryTable,
