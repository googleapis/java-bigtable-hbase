...
public class TestFlowController {
  ...
  public void testCancelledReservationFutureIsRemovedFromFlowControllerWaitersList()
    ...
    Future<ResourceReservation> reservationFuture1 = fc.asyncRequestResource(createRequest(1));

    Future<ResourceReservation> reservationFuture2 = fc.asyncRequestResource(createRequest(1));
