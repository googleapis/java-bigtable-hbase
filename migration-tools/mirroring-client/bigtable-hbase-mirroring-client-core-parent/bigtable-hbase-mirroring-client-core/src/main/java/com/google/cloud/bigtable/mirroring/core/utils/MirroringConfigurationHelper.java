...
public class MirroringConfigurationHelper {
   ...
   * changed, but a {@link com.google.cloud.bigtable.mirroring.core.MirroringOperationException} is
   * added as a root cause for thrown exceptions (For more details see {@link
   * com.google.cloud.bigtable.mirroring.core.MirroringOperationException}).
   *
   ...
   * com.google.cloud.bigtable.mirroring.core.MirroringConnection} should wait synchronously for
